...
@onready var transition = $"ParallaxBackground/ParallaxLayer/Sala_carrera(cajonera_abierta)/Transition"
...
@onready var dialog_label = $Dialogo_cja/Dialogo/Dialogo_cja # Nodo para el texto del diálogo
@onready var name_label = $Dialogo_cja/nombres/caja_nombre # Nodo para el texto del nombre
