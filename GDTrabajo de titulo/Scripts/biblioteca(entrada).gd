...
@onready var dialog_label = $Dialogo_biblioteca/Dialogo/Dialogo_biblioteca # Nodo para el texto del diálogo
@onready var name_label = $Dialogo_biblioteca/nombres/caja_nombre  # Nodo para el texto del nombre
...
func _on_button_3_pressed() -> void:
	next_scene = "res://Scenes/Biblioteca/Biblioteca(estanteria).tscn"
	transition.play("fade_out")
	AudioManager.steps_audio.play()
