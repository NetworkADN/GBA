...
@onready var transition = $ParallaxBackground/ParallaxLayer/UTEM/Transition
...
@onready var dialog_label = $Dialogo_ut/Dialogo/Dialogo_ut # Nodo para el texto del diálogo
@onready var name_label = $Dialogo_ut/nombres/caja_nombre # Nodo para el texto del nombre
...
func _on_button_pressed() -> void:
	next_scene = "res://Scenes/Patios/Patio_transa.tscn"
