...
@onready var transition = $"ParallaxBackground/ParallaxLayer/Casino(microondas)/Transition"
...
@onready var dialog_label = $Dialogo_mcr/Dialogo/Dialogo_mcr # Nodo para el texto del diálogo
@onready var name_label = $Dialogo_mcr/nombres/caja_nombre # Nodo para el texto del nombre
