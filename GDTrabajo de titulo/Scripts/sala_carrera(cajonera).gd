...
@onready var dialog_label = $Dialogo_cj/Dialogo/Dialogo_cj # Nodo para el texto del diálogo
@onready var name_label = $Dialogo_cj/nombres/caja_nombre # Nodo para el texto del nombre
